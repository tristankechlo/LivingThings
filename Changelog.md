...
- fix effect bugging out for `livingthings:ancient_helmet`
  ([#55](https://github.com/tristankechlo/LivingThings/issues/55) & [#68](https://github.com/tristankechlo/LivingThings/issues/68))
