...
public final class ModelLayer {
    ...
    public static final ModelLayerLocation CRAB_BABY = createLayerLocation("crab_baby");
    public static final ModelLayerLocation ELEPHANT = createLayerLocation("elephant");
    public static final ModelLayerLocation ELEPHANT_BABY = createLayerLocation("elephant_baby");
    public static final ModelLayerLocation FLAMINGO = createLayerLocation("flamingo");
    public static final ModelLayerLocation FLAMINGO_BABY = createLayerLocation("flamingo_baby");
    public static final ModelLayerLocation GIRAFFE = createLayerLocation("giraffe");
    public static final ModelLayerLocation GIRAFFE_BABY = createLayerLocation("giraffe_baby");
    public static final ModelLayerLocation KOALA = createLayerLocation("koala");
    public static final ModelLayerLocation KOALA_BABY = createLayerLocation("koala_baby");
    public static final ModelLayerLocation LION = createLayerLocation("lion");
    public static final ModelLayerLocation LION_BABY = createLayerLocation("lion_baby");
    ...
    public static final ModelLayerLocation MONKEY_BABY = createLayerLocation("monkey_baby");
    public static final ModelLayerLocation MONKEY_SITTING = createLayerLocation("monkey_sitting");
    public static final ModelLayerLocation MONKEY_SITTING_BABY = createLayerLocation("monkey_sitting_baby");
    ...
    public static final ModelLayerLocation OSTRICH_BABY = createLayerLocation("ostrich_baby");
    public static final ModelLayerLocation OWL = createLayerLocation("owl");
    public static final ModelLayerLocation OWL_BABY = createLayerLocation("owl_baby");
    public static final ModelLayerLocation PEACOCK = createLayerLocation("peacock");
    public static final ModelLayerLocation PEACOCK_BABY = createLayerLocation("peacock_baby");
    public static final ModelLayerLocation PENGUIN = createLayerLocation("penguin");
    public static final ModelLayerLocation PENGUIN_BABY = createLayerLocation("penguin_baby");
    public static final ModelLayerLocation RACCOON = createLayerLocation("raccoon");
    public static final ModelLayerLocation RACCOON_BABY = createLayerLocation("raccoon_baby");
    ...
    public static final ModelLayerLocation SNAIL_BABY = createLayerLocation("snail_baby");
