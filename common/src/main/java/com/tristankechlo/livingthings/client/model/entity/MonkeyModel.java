...
//		this.BackLeftLegBottom = BackLeftLegTop.getChild("BackLeftLegBottom");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 14).addBox(-3.0F, -2.9948F, -3.2964F, 6.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 16.8264F, 3.7609F, -0.0873F, 0.0F, 0.0F));
        PartDefinition BodyFront = Body.addOrReplaceChild("BodyFront", CubeListBuilder.create().texOffs(0, 23).addBox(-3.0F, -1.8282F, -5.0129F, 6.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.174F, -3.1568F, 0.0873F, 0.0F, 0.0F));
        PartDefinition Head = BodyFront.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 5).addBox(-2.5F, -3.9712F, -4.0871F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.2655F, -4.271F));
        PartDefinition MouthTop = Head.addOrReplaceChild("MouthTop", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -0.975F, -2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.022F, -3.3425F, 0.0873F, 0.0F, 0.0F));
        PartDefinition MouthBottom = Head.addOrReplaceChild("MouthBottom", CubeListBuilder.create().texOffs(19, 8).addBox(-1.5F, -0.475F, -2.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.2191F, -3.1611F, 0.3054F, 0.0F, 0.0F));
        PartDefinition EarRight = Head.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(28, 21).addBox(-0.5F, -0.95F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, -2.1589F, -2.0536F));
        PartDefinition EarLeft = Head.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(28, 21).mirror().addBox(-0.5F, -0.95F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(2.5F, -2.1589F, -2.0536F));
        PartDefinition FrontRightLegTop = BodyFront.addOrReplaceChild("FrontRightLegTop", CubeListBuilder.create().texOffs(15, 0).mirror().addBox(-1.0F, -0.9462F, -1.1566F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.5F, 0.8968F, -3.0129F, 0.1745F, 0.0F, 0.0F));
        ...
        PartDefinition FrontLeftLegTop = BodyFront.addOrReplaceChild("FrontLeftLegTop", CubeListBuilder.create().texOffs(15, 0).addBox(-1.0F, -0.9462F, -1.1566F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, 0.8968F, -3.0129F, 0.1745F, 0.0F, 0.0F));
        ...
        PartDefinition BackRightLegTop = Body.addOrReplaceChild("BackRightLegTop", CubeListBuilder.create().texOffs(15, 0).mirror().addBox(-1.0F, -1.2262F, -0.9925F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.5F, -0.075F, -0.0033F, -0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition BackLeftLegTop = Body.addOrReplaceChild("BackLeftLegTop", CubeListBuilder.create().texOffs(15, 0).addBox(-1.0F, -1.3012F, -0.9925F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(18, 20).addBox(-1.0F, -0.95F, 0.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.7519F, 0.3378F, 0.6545F, 0.0F, 0.0F));
        PartDefinition Tail2 = Tail.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(22, 14).addBox(-0.5F, -0.575F, 0.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.0568F, 4.3282F, 0.576F, 0.0F, 0.0F));
        PartDefinition Tail3 = Tail2.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(18, 13).addBox(-0.5F, -0.575F, 0.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.246F, 3.5488F, -0.9599F, 0.0F, 0.0F));
