...
public class BabyEnderDragonSittingModel extends AdvancedEntityModel<BabyEnderDragonEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(14, 17).addBox(-3.0F, -11.625F, 0.0F, 6.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 27).addBox(-1.0F, -13.375F, 5.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 27).addBox(-1.0F, -13.375F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 22.025F, -5.475F, -0.6981F, 0.0F, 0.0F));
        PartDefinition FrontBody = Body.addOrReplaceChild("FrontBody", CubeListBuilder.create().texOffs(0, 27).addBox(-2.0F, -4.75F, -7.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(19, 3).addBox(-4.0F, -3.0F, -8.0F, 6.0F, 6.0F, 7.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(1.0F, -9.5321F, 2.3712F, 0.5236F, 0.0F, 0.0F));
        PartDefinition FrontRightLeg = FrontBody.addOrReplaceChild("FrontRightLeg", CubeListBuilder.create().texOffs(46, 0).mirror().addBox(-1.25F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.5F, 2.0F, -5.0F, 0.1745F, 0.0F, 0.0F));
        ...
        PartDefinition FrontLeftLeg = FrontBody.addOrReplaceChild("FrontLeftLeg", CubeListBuilder.create().texOffs(46, 0).addBox(-1.75F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 2.0F, -5.0F, 0.1745F, 0.0F, 0.0F));
        ...
        PartDefinition LeftWing = FrontBody.addOrReplaceChild("LeftWing", CubeListBuilder.create().texOffs(48, 22).addBox(-0.1304F, -1.3933F, -1.4429F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(47, 8).addBox(-0.5848F, 0.15F, 0.9F, 5.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, -1.6F, -5.5F, 0.0F, 0.0F, -1.1781F));
        PartDefinition LeftWing2 = LeftWing.addOrReplaceChild("LeftWing2", CubeListBuilder.create().texOffs(44, 28).mirror().addBox(0.7886F, -1.5405F, -1.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(41, 15).mirror().addBox(0.5566F, -0.5713F, 1.025F, 8.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.4052F, -0.6469F, -0.1421F, 0.0F, 0.0F, 2.3998F));
        PartDefinition RightWing = FrontBody.addOrReplaceChild("RightWing", CubeListBuilder.create().texOffs(48, 22).mirror().addBox(-4.8696F, -1.3933F, -1.4429F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(47, 8).mirror().addBox(-4.4152F, 0.15F, 0.9F, 5.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.5F, -1.6F, -5.5F, 0.0F, 0.0F, 1.1781F));
        PartDefinition RightWing2 = RightWing.addOrReplaceChild("RightWing2", CubeListBuilder.create().texOffs(44, 28).addBox(-8.7886F, -1.5405F, -1.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(41, 15).addBox(-8.5566F, -0.5713F, 1.025F, 8.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.4052F, -0.6469F, -0.1421F, 0.0F, 0.0F, -2.3998F));
        PartDefinition BackRightLeg = Body.addOrReplaceChild("BackRightLeg", CubeListBuilder.create().texOffs(46, 0).mirror().addBox(-1.25F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.5F, -9.85F, 4.5F, 0.6981F, 0.0F, 0.0F));
        ...
        PartDefinition BackLeftLeg = Body.addOrReplaceChild("BackLeftLeg", CubeListBuilder.create().texOffs(46, 0).mirror().addBox(-1.25F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.0F, -9.85F, 4.5F, 0.6981F, 0.0F, 0.0F));
        PartDefinition BackLeftLegLower = BackLeftLeg.addOrReplaceChild("BackLeftLegLower", CubeListBuilder.create().texOffs(56, 0).mirror().addBox(-0.75F, 1.475F, -1.1782F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 2.325F, 1.0F, -0.5236F, 0.0F, 0.0F));
        PartDefinition BackLeftFoot = BackLeftLegLower.addOrReplaceChild("BackLeftFoot", CubeListBuilder.create().texOffs(11, 16).mirror().addBox(-3.25F, 3.3F, 3.775F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.0F, 4.0F, -6.9282F, 0.5236F, 0.0F, 0.0F));
        PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(38, 0).addBox(-1.0F, 0.0F, -0.75F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 0).addBox(-0.5F, 0.5F, 1.25F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.7478F, 8.6125F, 1.825F, 0.0F, 0.0F));
        PartDefinition Tail2 = Tail.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(38, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 0).addBox(-0.5F, 0.5F, 1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.75F, 0.25F, 0.2094F, 0.0F, 0.0F));
        PartDefinition Tail3 = Tail2.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(38, 0).addBox(-1.0F, 0.0F, -1.0216F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 0).addBox(-0.5F, 0.5F, 0.9784F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.75F, 0.0216F, 0.1134F, 0.0F, 0.0F));
        PartDefinition Tail4 = Tail3.addOrReplaceChild("Tail4", CubeListBuilder.create().texOffs(38, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 0).addBox(-0.5F, 0.5F, 1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.75F, -0.0216F, 0.1309F, 0.0F, 0.0F));
