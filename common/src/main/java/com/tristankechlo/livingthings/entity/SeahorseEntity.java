...
public class SeahorseEntity extends AbstractSchoolingFish implements IMobVariants, ILexiconEntry {
    ...
    public static boolean checkSeahorseSpawnRules(EntityType<SeahorseEntity> entity, LevelAccessor world, EntitySpawnReason reason, BlockPos pos, RandomSource random) {
