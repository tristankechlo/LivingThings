...
public final class NetherKnightConfig extends EntityConfig {
    ...
    public final DoubleValue weaponDropChance = new DoubleValue("weaponDropChance", 100, 0, 100);

    public final IntegerValue spawnWeight = new IntegerValue("spawnWeight", 18, 1, Short.MAX_VALUE);
