...
public final class ModItems {
    ...
    public static final RegistryObject<Item> ANCIENT_HELMET = registerItem("ancient_helmet", () -> new ArmorItem(ModArmorMaterial.ANCIENT, ArmorItem.Type.HELMET, normalProps().stacksTo(1)));
