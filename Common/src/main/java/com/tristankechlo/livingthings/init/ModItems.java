...
public final class ModItems {
    ...
    public static final RegistryObject<Item> PEACOCK_SPAWN_EGG = ITEMS.register("peacock_spawn_egg", () -> new SpawnEggItem(ModEntityTypes.PEACOCK.get(), 0x117fc7, 0x86d43b, normalProps()));
