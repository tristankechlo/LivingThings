...
public class ShroomieRenderer extends MobRenderer<ShroomieEntity, EntityModel<ShroomieEntity>> {
    ...
    private static final ResourceLocation RED = ModelLayer.getEntityTexture("shroomie/shroomie_red.png");
    private static final ResourceLocation BROWN = ModelLayer.getEntityTexture("shroomie/shroomie_brown.png");
