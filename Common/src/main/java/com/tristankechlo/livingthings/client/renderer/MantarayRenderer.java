...
public class MantarayRenderer extends MobRenderer<MantarayEntity, MantarayModel<MantarayEntity>> {
    ...
    protected static final ResourceLocation TEXTURE_BLUE = LivingThingsClient.getEntityTexture("mantaray/mantaray_blue.png");
    protected static final ResourceLocation TEXTURE_BROWN = LivingThingsClient.getEntityTexture("mantaray/mantaray_brown.png");
