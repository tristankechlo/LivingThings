...
public class LionRenderer extends MobRenderer<LionEntity, LionModel<LionEntity>> {
    ...
    protected static final ResourceLocation TEXTURE = ModelLayer.getEntityTexture("lion/lion.png");
    protected static final ResourceLocation TEXTURE_WHITE = ModelLayer.getEntityTexture("lion/lion_white.png");
