...
public class FlamingoModel<T extends FlamingoEntity> extends AdvancedEntityModel<T> {
	...
	@Override
	public void setRotationAngles(FlamingoEntity flamingo, float limbSwing, float limbSwingAmount, float ageInTicks,
		...
		if (flamingo.isLeftLegUp()) {
			...
			this.LeftLegTop.rotateAngleX = 0.1308996937F
