...
public class ElephantModel<T extends ElephantEntity> extends AdvancedEntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftEar = Head.addOrReplaceChild("LeftEar",
				CubeListBuilder.create().texOffs(220, 37).mirror()
						.addBox(0.0F, -8.0F, 0.0F, 1.0F, 12.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition Tusks = Head.addOrReplaceChild("Tusks", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition RightTusk = Tusks.addOrReplaceChild("RightTusk", CubeListBuilder.create(),
				PartPose.offset(-7.0F, 6.0F, -9.0F));

		PartDefinition RightTuskTop = RightTusk.addOrReplaceChild("RightTuskTop", CubeListBuilder.create()
				.texOffs(192, 0).addBox(-15.0F, 0.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(14.0F, 0.0F, 0.0F));

		PartDefinition RightTuskMiddle = RightTuskTop.addOrReplaceChild("RightTuskMiddle",
				CubeListBuilder.create().texOffs(204, 0).mirror()
						.addBox(-15.0F, -0.35F, -1.05F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.001F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 10.0F, 0.0F, -0.3054F, 0.0F, 0.0F));

		PartDefinition RightTuskBottom = RightTuskMiddle.addOrReplaceChild("RightTuskBottom",
				CubeListBuilder.create().texOffs(215, 0).addBox(-15.0F, -0.85F, -1.475F, 2.0F, 5.0F, 2.0F,
		...
		PartDefinition LeftTuskTop = LeftTusk.addOrReplaceChild("LeftTuskTop",
				CubeListBuilder.create().texOffs(192, 0).mirror()
						.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition LeftTuskMiddle = LeftTuskTop.addOrReplaceChild("LeftTuskMiddle",
				CubeListBuilder.create().texOffs(204, 0).addBox(-1.0F, -0.35F, -1.05F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(-0.001F)),
				PartPose.offsetAndRotation(0.0F, 10.0F, 0.0F, -0.3054F, 0.0F, 0.0F));

		PartDefinition LeftTuskBottom = LeftTuskMiddle.addOrReplaceChild("LeftTuskBottom",
				CubeListBuilder.create().texOffs(215, 0).mirror()
						.addBox(-1.0F, -0.85F, -1.475F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.002F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 6.0F, 0.0F, -0.6545F, 0.0F, 0.0F));

		PartDefinition RightFrontLeg = Body.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create().texOffs(95, 0)
				.addBox(-3.0F, 1.0F, -3.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-8.0F, -19.0F, -16.0F));

		PartDefinition LeftFrontLeg = Body.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create().texOffs(68, 0)
				.addBox(-3.0F, 1.0F, -3.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, -19.0F, -16.0F));

		PartDefinition LeftBackLeg = Body.addOrReplaceChild("LeftBackLeg", CubeListBuilder.create().texOffs(122, 0)
				.addBox(-3.0F, 1.0F, -3.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, -19.0F, 16.0F));

		PartDefinition RightBackLeg = Body.addOrReplaceChild("RightBackLeg", CubeListBuilder.create().texOffs(149, 0)
				.addBox(-3.0F, 1.0F, -3.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-8.0F, -19.0F, 16.0F));

		PartDefinition Chests = Body.addOrReplaceChild("Chests",
				CubeListBuilder.create().texOffs(54, 38)
						.addBox(11.0F, -37.0F, 9.5F, 2.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(54, 38)
						.mirror().addBox(-13.0F, -37.0F, 9.5F, 2.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(127, 112).mirror()
						.addBox(10.2F, -42.475F, 11.5F, 1.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(127, 112).addBox(-11.2F, -42.475F, 11.5F, 1.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(127, 105).addBox(-8.5F, -43.475F, 11.5F, 17.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition HolderLeft = Chests.addOrReplaceChild("HolderLeft",
				CubeListBuilder.create().texOffs(173, 104).addBox(-1.5F, -0.5F, -2.0F, 3.0F, 2.0F, 4.0F,
						new CubeDeformation(-0.001F)),
		...
		PartDefinition Saddle = Body.addOrReplaceChild("Saddle", CubeListBuilder.create().texOffs(127, 112)
				.addBox(-6.5F, -44.0F, -7.0F, 13.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(128, 100)
				.addBox(-6.0F, -45.0F, 3.0F, 12.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(181, 113)
				.addBox(-11.2F, -42.475F, -2.0F, 1.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(181, 113)
				.mirror().addBox(10.2F, -42.475F, -2.0F, 1.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(168, 117).addBox(-1.5F, -46.0F, -7.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(245, 43).addBox(10.4F, -32.5F, -2.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(245, 43).addBox(-11.4F, -32.5F, -2.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(245, 43).addBox(10.375F, -32.0F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(245, 43).addBox(-11.375F, -32.0F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition SaddleRight = Saddle.addOrReplaceChild("SaddleRight",
				CubeListBuilder.create().texOffs(158, 100).addBox(-2.5492F, -0.0726F, -0.5F, 5.0F, 1.0F, 2.0F,
						new CubeDeformation(-0.001F)),
		...
		PartDefinition SaddleLeft = Saddle.addOrReplaceChild("SaddleLeft",
				CubeListBuilder.create().texOffs(158, 100).mirror()
						.addBox(-2.5492F, -0.0726F, -0.5F, 5.0F, 1.0F, 2.0F, new CubeDeformation(-0.001F))
						.mirror(false),
