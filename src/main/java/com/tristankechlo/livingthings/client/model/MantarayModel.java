...
public class MantarayModel<T extends MantarayEntity> extends EntityModel<T> {
	...
	public MantarayModel() {
		...
		Tail.addChild(Tail2);
		Tail2.setTextureOffset(33, 42).addBox(-0.5F, -1.5F, 0.0F, 1.0F, 1.0F, 6.0F, 0.0F, false);
	...
	public void setRotationAngles(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		this.Tail.rotateAngleX = -0.5F * headPitch * ((float) Math.PI / 180F);
		this.Tail2.rotateAngleX = -0.25F * headPitch * ((float) Math.PI / 180F);
