	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition
				.addOrReplaceChild("Body",
						CubeListBuilder.create().texOffs(0, 17).addBox(-3.5F, -9.025F, -3.5F, 7.0F, 9.0F, 6.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 21.5F, 1.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition LeftWing = Body.addOrReplaceChild("LeftWing",
				CubeListBuilder.create().texOffs(0, 1).addBox(0.0F, 0.0F, -3.0F, 1.0F, 8.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.5F, -8.5792F, -0.4056F, 0.0F, 0.0F, -0.1309F));

		PartDefinition RightWing = Body.addOrReplaceChild("RightWing",
				CubeListBuilder.create().texOffs(15, 1).addBox(-1.0F, 0.0F, -3.0F, 1.0F, 8.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, -8.5792F, -0.4056F, 0.0F, 0.0F, 0.1309F));

		PartDefinition LeftLeg = Body.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(31, 1).addBox(-1.0F, 0.1224F, -0.5671F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, -1.9107F, -1.5699F, -0.2618F, 0.0F, 0.0F));

		PartDefinition LeftFoot = LeftLeg.addOrReplaceChild("LeftFoot",
				CubeListBuilder.create().texOffs(40, 3).addBox(-1.0667F, -0.0681F, -1.058F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0667F, 3.0978F, 0.5107F, 0.0873F, 0.0F, 0.0F));

		PartDefinition RightToeLeftFoot = LeftFoot.addOrReplaceChild("RightToeLeftFoot",
				CubeListBuilder.create().texOffs(49, 4).addBox(-0.5F, -0.475F, -0.925F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5667F, 0.4082F, -1.0494F, 0.0F, 0.1745F, 0.0F));

		PartDefinition LeftToeLeftFoot = LeftFoot.addOrReplaceChild("LeftToeLeftFoot",
				CubeListBuilder.create().texOffs(54, 4).addBox(-0.5F, -0.5F, -0.925F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4333F, 0.4332F, -1.0494F, 0.0F, -0.1745F, 0.0F));

		PartDefinition RightLeg = Body.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(31, 7).addBox(-1.0F, 0.1224F, -0.5671F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -1.9107F, -1.5699F, -0.2618F, 0.0F, 0.0F));

		PartDefinition RightFoot = RightLeg.addOrReplaceChild("RightFoot",
				CubeListBuilder.create().texOffs(40, 9).addBox(-1.0667F, -0.0681F, -1.058F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0667F, 3.0978F, 0.5107F, 0.0873F, 0.0F, 0.0F));

		PartDefinition RightToeRightFoot = RightFoot.addOrReplaceChild("RightToeRightFoot",
				CubeListBuilder.create().texOffs(49, 10).addBox(-0.5F, -0.475F, -0.925F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5667F, 0.4082F, -1.0494F, 0.0F, 0.1745F, 0.0F));

		PartDefinition LeftToeRightFoot = RightFoot.addOrReplaceChild("LeftToeRightFoot",
				CubeListBuilder.create().texOffs(54, 10).addBox(-0.5F, -0.5F, -0.925F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4333F, 0.4332F, -1.0494F, 0.0F, -0.1745F, 0.0F));

		PartDefinition Tail = Body.addOrReplaceChild("Tail",
				CubeListBuilder.create().texOffs(31, 13).addBox(-1.0F, -0.5186F, -0.2595F, 2.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.7652F, 1.3264F, -0.9599F, 0.0F, 0.0F));

		PartDefinition Head = Body.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(27, 20).addBox(-3.5F, -6.0F, -3.25F, 7.0F, 6.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -8.5045F, -0.1394F, -0.1745F, 0.0F, 0.0F));

		PartDefinition Beak = Head.addOrReplaceChild("Beak",
				CubeListBuilder.create().texOffs(42, 14).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.25F, -2.7F, 0.4363F, 0.0F, 0.0F));
