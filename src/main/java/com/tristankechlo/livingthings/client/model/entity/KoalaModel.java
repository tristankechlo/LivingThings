...
public class KoalaModel <T extends KoalaEntity> extends EntityModel<T>{
	...
	public KoalaModel() {
		...
		setRotationAngle(BodyBack, -0.1309F, 0.0F, 0.0F);
		...
		setRotationAngle(EarLeft, 0.0F, 0.0F, 0.1309F);
		...
		setRotationAngle(EarRight, 0.0F, 0.0F, -0.1309F);
		...
		Nose.addChild(Nose2);
		setRotationAngle(Nose2, 0.0873F, 0.0F, 0.0F);
		...
		setRotationAngle(LegFrontLeft, 0.0873F, 0.0F, -0.0873F);
		...
		setRotationAngle(LegFrontLeft2, 0.0F, 0.0F, 0.0873F);
		...
		setRotationAngle(LegBackLeft, 0.0F, 0.0F, -0.0873F);
		...
		setRotationAngle(LegBackLeft2, 0.0873F, 0.0F, 0.0873F);
		...
		setRotationAngle(LegFrontRight, 0.0873F, 0.0F, 0.0873F);
		...
		setRotationAngle(LegFrontRight2, 0.0F, 0.0F, -0.0873F);
		...
		setRotationAngle(LegBackRight, 0.0F, 0.0F, 0.0873F);
		...
		setRotationAngle(LegBackRight2, 0.0873F, 0.0F, -0.0873F);
