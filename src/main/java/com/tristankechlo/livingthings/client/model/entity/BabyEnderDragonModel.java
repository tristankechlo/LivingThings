...
public class BabyEnderDragonModel extends AdvancedEntityModel<BabyEnderDragonEntity> {
	...
	public BabyEnderDragonModel(ModelPart root) {
		...
		this.LeftWing = this.FrontBody.getChild("LeftWing");
		this.LeftWing2 = this.LeftWing.getChild("LeftWing2");
		this.RightWing = this.FrontBody.getChild("RightWing");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition FrontLeftLeg = FrontBody.addOrReplaceChild("FrontLeftLeg", CubeListBuilder.create()
				.texOffs(46, 0).addBox(-1.75F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Neck = FrontBody.addOrReplaceChild("Neck",
				...
				PartPose.offset(-1.0F, -0.02F, -6.75F));
		...
		PartDefinition LeftWing = FrontBody.addOrReplaceChild("LeftWing",
				...
				PartPose.offsetAndRotation(1.5F, -2.0F, -5.5F, 0.0F, 0.0F, -0.3491F));
		...
		PartDefinition RightWing = FrontBody.addOrReplaceChild("RightWing",
				...
				PartPose.offsetAndRotation(-3.5F, -2.0F, -5.5F, 0.0F, 0.0F, 0.3491F));
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail",
				...
				PartPose.offsetAndRotation(0.0F, -10.15F, 8.275F, 1.3526F, 0.0F, 0.0F));
		...
		PartDefinition Tail2 = Tail.addOrReplaceChild("Tail2",
				...
				PartPose.offsetAndRotation(0.0F, 3.75F, 0.25F, -0.3491F, 0.0F, 0.0F));
	...
	@Override
	public void prepareMobModel(BabyEnderDragonEntity entity, float limbSwing, float limbSwingAmount,
			float partialTick) {
