...
@OnlyIn(Dist.CLIENT)
public class NetherKnightHeldItemLayer<M extends EntityModel<NetherKnightEntity> & ArmedModel>
		extends RenderLayer<NetherKnightEntity, M> {
	...
	public void render(PoseStack mStack, MultiBufferSource buffer, int p_225628_3_, NetherKnightEntity entity,
		...
		if (!itemstack.isEmpty() || !itemstack1.isEmpty()) {
			mStack.pushPose();
			this.renderArmWithItem(entity, itemstack1, TransformType.THIRD_PERSON_RIGHT_HAND, HumanoidArm.RIGHT, mStack,
					buffer, p_225628_3_);
			this.renderArmWithItem(entity, itemstack, TransformType.THIRD_PERSON_LEFT_HAND, HumanoidArm.LEFT, mStack,
					buffer, p_225628_3_);
			mStack.popPose();
		}
	}
