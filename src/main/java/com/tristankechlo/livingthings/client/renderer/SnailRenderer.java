...
public class SnailRenderer extends MobRenderer<SnailEntity, EntityModel<SnailEntity>> {
	...
	public SnailRenderer(Context context) {
		...
		this.addLayer(new SnailShellPatternLayer(this, context.getModelSet(), PatternType.BACKGROUND));
		this.addLayer(new SnailShellPatternLayer(this, context.getModelSet(), PatternType.FOREGROUND));
	}
