...
public class AncientBlazeConfig {
	...
	public AncientBlazeConfig(ForgeConfigSpec.Builder builder) {
		...
		largeFireballAmount = builder.comment("max amount of large fireballs to shoot").worldRestart().defineInRange("LargeFireballCount", 6, 0, 10);
		largeFireballChance = builder.comment("chance for the attack to be a large fireball").worldRestart().defineInRange("LargeFireballChance", 20, 0, 100);
